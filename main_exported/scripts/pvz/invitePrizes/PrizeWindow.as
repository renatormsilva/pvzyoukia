package pvz.invitePrizes
{
   ...
   public class PrizeWindow extends BaseWindow
   {
      ...
      public function PrizeWindow(param1:DisplayObjectContainer)
      {
         super();
      ...
      public function show(param1:Array, param2:Function) : void
      {
         if(param1 == null)
         {
            return;
      ...
      private function doLayout() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            {
               _loc3_ = new PrizesLabel(_loc1_[_loc2_]);
               _loc4_ = _loc2_ % 4;
               _loc5_ = _loc2_ / 4;
