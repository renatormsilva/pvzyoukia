package pvz.world
{
   ...
   public class InsideWorldScalePanel extends Sprite implements IDestroy
   {
      ...
      public function InsideWorldScalePanel(param1:DisplayObject, param2:int = 3)
      {
         super();
      ...
      {
         var _loc1_:Class = DomainAccess.getClass("ui.world.scalePanel");
      ...
      private function changeScale() : void
      {
         ...
         dispatchEvent(new InsideWorldEvent(InsideWorldEvent.LOCTION_CHANGE,0));
      }
